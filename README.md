...
- **[ADU Florida Info](https://github.com/themutherfvcker/ADU-Florida/tree/main/mcp/adu-zoning-mcp)** - Check whether a Florida address can build an ADU (accessory dwelling unit): live county-GIS zoning, an eligibility verdict, and local rules. Remote (https://www.adufloridainfo.com/api/mcp) or `npx adu-zoning-mcp`.
